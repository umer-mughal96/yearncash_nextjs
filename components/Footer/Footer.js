            ...
            <div className="row">
                ...
                <div className="col-md-2">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li><a target="_blank" href="https://twitter.com/devscash"><i class="fab fa-twitter"></i> @yearnwallet</a></li>
                        <li><a target="_blank" href="https://www.instagram.com/yearn.cash"><i class="fab fa-instagram"></i> @YearnCash</a></li>
                        <li><a target="_blank" href="https://t.me/Yficgenesis"><i class="fab fa-telegram-plane"></i> @yearnwallet</a></li>
